...
def split_sites_func(user,pdb):
    pdb = '/home/hd/hd_hd/{user}/switchable-split-proteins/data/{pdb}.pdb'
    temp = stride(pdb, system='mac', stride_dir='/home/hd/hd_hd/{user}/.conda/envs/main/bin/stride', output_dir='/data/strideout')
